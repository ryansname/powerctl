...
func powerExcessCalculator(
	...
	for {
		...
		case data := <-dataChan:
			...
			solar1Power := data.GetFloat(TopicSolar1Power).Average._5
			if solar1Power > 1000 {
				excessWatts += 1000
			}
